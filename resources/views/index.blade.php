						...
						<div class="page-header">
							<div class="page-leftheader">
								<h3 class="page-title mb-0">Hi! {{Auth::user()->name?? 'Admin'}}</h3>
								<ol class="breadcrumb">
							...
							<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
								<div class="card overflow-hidden dash1-card border-0">
									<div class="card-body">
										...
										<h2 class="mb-1 number-font">NGN3,257</h2>
							...
							<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
								<div class="card overflow-hidden dash1-card border-0">
									<div class="card-body">
										...
										<h2 class="mb-1 number-font">NGN2,590</h2>
										<small class="fs-12 text-muted">Compared to Last Month</small>
							...
							<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
								<div class="card overflow-hidden dash1-card border-0">
									<div class="card-body">
										...
										<h2 class="mb-1 number-font">NGN1,954</h2>
										<small class="fs-12 text-muted">Compared to Last Month</small>
									...
									<div class="card-body">
										<div class="row mb-3">
											<div class="col-xl-3 col-6">
												<p class="mb-1">Total Bookings</p>
												<h3 class="mb-0 fs-20 number-font1">NGN 52,618</h3>
											...
											<div class="col-xl-3 col-6 ">
												...
												<h3 class="mb-0 fs-20 number-font1">NGN 26,197</h3>
